...
public abstract class BaseCommand<T> implements Command<T> {
	...
	public BaseCommand(Class<T> type, AerospikeClient synCLient, AsyncClient asyncClient, ClassConstructor classConstructor) {
	...
	public BaseCommand<T> namespace(String namespace) {
		this.namespace = namespace;
		return this;
	}

	public BaseCommand<T> set(String setName) {
		this.setName = setName;
		return this;
	}

	public BaseCommand<T> key(String key) {
		this.stringKey = key;
		this.longKey = null;
		return this;
	}

	public BaseCommand<T> key(long key) {
		this.longKey = key;
		this.stringKey = null;
		return this;
	}

	public BaseCommand<T> policy(WritePolicy policy) {
		this.policy = policy;
		this.policy.sendKey = true;
		return this;
	}
